...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 08, 2021 lúc 07:18 PM
...
INSERT INTO `chitiethoadon` (`id_cthd`, `soluong_cthd`, `dia_chi`, `id_hd`, `id_sp`) VALUES
(1, 3, '34 Phan Chu Trinh Nha Trang ', 1, 22),
(2, 5, '21 Hồn Chồng Nha Trang ', 2, 2),
(3, 1, '3 Ninh HòaKhánh Hòa', 3, 24),
(4, 2, '211 Núi Một Nha Trang ', 4, 14),
(5, 3, '399 Ninh An Khánh Hòa', 5, 24),
(6, 4, '21 Sông Hinh Phú yên', 6, 1);
...
INSERT INTO `hoadon` (`id_hd`, `id_nd`, `id_tt`, `thanh_toan`) VALUES
(1, 5, 2, 0),
(2, 4, 4, 1),
(3, 1, 1, 0),
(4, 6, 3, 0),
...
INSERT INTO `nguoidung` (`id_nd`, `ten_nd`, `sdt_nd`, `gmail`, `pass`, `gioitinh`, `id_lnd`) VALUES
(1, 'Nguyễn Thị Lê', '0963747263', 'le@gmail.com', '123', 0, 2),
(2, 'Trần Văn Nam', '0993647365', 'nam@gmail.com', '123', 1, 2),
(4, 'Lê Đại Phát', '0998364623', 'phat@gmail.com', '1', 1, 2),
(5, 'Hà MInh Tài', '09763346211', 'tai@gmail.com', '123', 1, 2),
(6, 'Trần Thị Anh', '0988135641', 'anh@gmail.com', '12', 0, 2),
(7, 'Hồ Đại Phong', '096374343', 'phong@gmail.com', '', 1, 2),
(8, 'Trần Văn Lợi', '0993647360', 'loi@gmail.com', '', 0, 2),
(15, 'la thi haiiiiiiiiiiiiiiii', '23131', 'hai@gmail.com', '', 1, 1),
(16, 'Trần Văn siiiiiiiiiiii', '0998364699', 'si@gmail.com', '', 1, 1),
(17, 'Nguyễn Thị Liên', '09637472631111', 'lien@gmail.com111', '123', 1, 1),
(18, 'Trần Văn ro', '09637472631111', 'ro@gmail.com111', '12', 1, 1),
(19, 'Trần Văn rong', '09637472631111', 'rong@gmail.com111', '123', 1, 1),
(20, 'ronaldo', '09637472631111', 'do@gmail.com111', '1', 1, 1),
(22, 'Trần Văn ro00000', '09637472631111', 'ro00@gmail.com111', '12', 1, 2),
(23, 'Lê Thị na', '09163434', 'na@gmail.com', '12', 0, 1),
(24, 'Trần Văn Lương', '3453366', 'luong@gmail.com ', '123', 0, 1),
(25, 'sssss', '6767858', 'ssss@gmail.com', '123', 0, 1),
(26, 'lllll', '232224', 'llll@gmail.com111', '123', 0, 1),
(27, 'vvvv', '09637472631', 'vvvvv@gmail.com', '123', 0, 2),
(28, '000', '09637472631', '000@gmail.com', '123', 0, 2),
(29, 'gggg', '124235', 'ggggg@gmail.com', '123', 0, 2);
...
(47, 'bbbbbbbbbdddd', 12334, 'images/andes.jpg', 12, 'mô tả  12', 1);
...
--
ALTER TABLE `chitiethoadon`
  MODIFY `id_cthd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `hoadon`
--
ALTER TABLE `hoadon`
  MODIFY `id_hd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `nguoidung`
  MODIFY `id_nd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
